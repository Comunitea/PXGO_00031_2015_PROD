...
class account_payment_term(osv.osv):
    ...
    _columns={
        'payment_days':fields.char(
            ...
            help="If a company has more than one payment days in a month you should fill them in this field and set 'Day of the Month' field in line to zero. For example, if a company pays the 5th and 20th days of the month you should write '5-20' here."),
    }
